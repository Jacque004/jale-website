                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <a class="btn btn-success" href="<?php if(isset($uid)): ?>nvAnnonces.php <?php else: ?> /jalegreatdeal/View/connexion.php <?php endif; ?>">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <ul class="product-variation">
                                                        ...
                                                        <span class="badge badge-primary">Nike <i class="fa-solid fa-heart mx-2"></i></span>
                                                        <?php elseif ($tableau["categorie"]==2): ?>
                                                        <span class="badge badge-warning">New Balance<i class="fa-solid fa-user-secret mx-2"></i></span>
                                                        <?php elseif ($tableau["categorie"]==3): ?>
                                                        <span class="badge badge-info">Adidas <i class="fa-solid fa-rocket mx-2"></i></span>
                                                        <?php elseif ($tableau["categorie"]==4): ?>
                                                        <span class="badge badge-danger">Zara <i class="fa-solid fa-feather-pointed mx-2"></i></span>
                                                        <?php else: ?>
                                                        <span class="badge badge-success">Beshka <i class="fa-solid fa-earth-europe mx-2"></i></span>
                                                        <?php endif; ?>
                                                </ul>
                                                <a href="detail.php?ida=<?= $tableau["ida"] ?>" class="btn btn-inverse-success">Voir</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php endforeach; ?>
